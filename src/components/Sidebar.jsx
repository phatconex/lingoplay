...
import { Home, BookOpen, LogOut, Layers } from 'lucide-react';
...
export default function Sidebar() {
  ...
  return (
    <div className="w-[280px] h-screen bg-white border-r-2 border-slate-200 flex flex-col p-6 sticky top-0 shrink-0">
      <div
      ...
      <div className="mt-auto pt-6 border-t-2 border-slate-100">
        <div className="flex items-center gap-3 mb-4">
          <img
            src={user?.user_metadata?.avatar_url || `https://ui-avatars.com/api/?name=${user?.email}&background=E8EBF5&color=2845D6`}
