...
export default function EditWordModal({ word, setId, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (word) {
        // Update existing
        console.log('Attempting update word:', { id: word.id, formData });
        ...
        if (error) {
            ...
            alert('Lỗi khi sửa từ: ' + error.message + ' (Code: ' + error.code + ')');
            throw error;
        }
        ...
        // Create new
        console.log('Attempting create word:', { setId, formData });
