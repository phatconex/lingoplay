...
export default function CreateSetModal({ isOpen, onClose, onSuccess, userId }) {
  ...
  return (
    <div className="fixed inset-0 bg-[#0D1A63]/60 z-[100] flex items-center justify-center p-4 animate-fade-in backdrop-blur-sm px-4 py-8 overflow-y-auto">
      <div className="bg-white w-full max-w-2xl rounded-[32px] shadow-2xl relative my-auto animate-slide-up overflow-hidden border border-slate-100 flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="p-6 md:p-8 flex flex-col gap-6">
          ...
          <div className="flex gap-4 mt-2">
            <button 
              ...
              onClick={onClose}
              disabled={loading}
              className="flex-1 py-4 font-bold text-lg rounded-2xl bg-slate-100 hover:bg-slate-200 text-slate-500 transition-colors pointer"
            >
              Hủy
            </button>
            <button 
