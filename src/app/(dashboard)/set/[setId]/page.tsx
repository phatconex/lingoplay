...
import { Target, Pencil, Zap, BookOpen, GraduationCap, ChevronLeft, Loader2, Clock, FileText, X, Mic } from 'lucide-react';
...
const MODES = [
  ...
  },
  {
    ...
    icon: <Mic size={30} strokeWidth={2.5} color="white" />,
    minWords: 1,
  },
];
...
export default function VocabDetailPage() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto flex flex-col animate-fade-in p-4 md:p-8 pb-24 overflow-y-auto text-[#0D1A63]">
      {/* Back + Header */}
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
        {allModes.map(mode => {
          ...
          return (
            ...
            >
              {isDoneToday && (
                <div className="absolute top-2 right-2 bg-white text-[#58CC02] w-6 h-6 rounded-full flex items-center justify-center shadow-md z-10">
      ...
      {showReadingModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="bg-white rounded-3xl w-full max-w-md relative z-10 p-6 md:p-8 shadow-2xl text-[#0D1A63]">
            <button
